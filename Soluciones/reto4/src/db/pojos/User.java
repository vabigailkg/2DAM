...
public abstract class User {
	...
	@Override
	public int hashCode() {
		return Objects.hash(address, birthday, city, firstSurname, idCard, isAdmin, isBlocked, lastAccess, login, name,
				password, postalCode, province, registerDate, secondSurname, userType);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && Objects.equals(birthday, other.birthday)
				&& Objects.equals(city, other.city) && Objects.equals(firstSurname, other.firstSurname)
	...
	public String toString() {
		return "User [name=" + name + ", firstSurname=" + firstSurname + ", secondSurname=" + secondSurname
				+ ", idCard=" + idCard + ", birthday=" + birthday + ", address=" + address + ", postalCode="
