...
public class CreationAuthorPanel extends JPanel {
	...
	public CreationAuthorPanel(ArrayList<JPanel> panels) {
		panel = new JPanel();
		...
		btnNewButtonCancel.setBounds(234, 247, 89, 23);
		panel.add(btnNewButtonCancel);

		JButton btnNewButtonRemove = new JButton("Eliminar");
		btnNewButtonRemove.setBounds(108, 247, 89, 23);
