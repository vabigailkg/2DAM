...
public class MainPanelAdmin extends JPanel {
	...
	private PremiumUser premium = new PremiumUser();
	private FreeUser free = new FreeUser();

	public MainPanelAdmin(ArrayList<JPanel> panels) {
		panel = new JPanel();
		...
		btnNewButtonGroups.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panels.get(19).setVisible(false);
